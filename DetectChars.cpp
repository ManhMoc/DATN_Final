...
static const int MIN_PIXEL_WIDTH = 2;
static const int MIN_PIXEL_HEIGHT = 8;

static const double MIN_ASPECT_RATIO = 0.25;
static const double MAX_ASPECT_RATIO = 1.0;

static const int MIN_PIXEL_AREA = 80;

// constants for comparing two chars
static const double MIN_DIAG_SIZE_MULTIPLE_AWAY = 0.3;
static const double MAX_DIAG_SIZE_MULTIPLE_AWAY = 5.0;

static const double MAX_CHANGE_IN_AREA = 0.5;

static const double MAX_CHANGE_IN_WIDTH = 0.8;
static const double MAX_CHANGE_IN_HEIGHT = 0.2;

static const double MAX_ANGLE_BETWEEN_CHARS = 12.0;

// other constants
static const int MIN_NUMBER_OF_MATCHING_CHARS = 3;

static const int RESIZED_CHAR_IMAGE_WIDTH = 20;
static const int RESIZED_CHAR_IMAGE_HEIGHT = 30;

static const int MIN_CONTOUR_AREA = 100;

static const cv::Scalar SCALAR_GREEN = cv::Scalar(0.0, 255.0, 0.0);
// global variables ///////////////////////////////////////////////////////////////////////////////
...
bool loadKNNDataAndTrainKNN(void) {
    ...
    cv::FileStorage fsClassifications("/home/pi/QT5/T4/classifications.xml", cv::FileStorage::READ);        // open the classifications file

    if (fsClassifications.isOpened() == false) {                                                        // if the file was not opened successfully
        std::cout << "error, unable to open training classifications file class.xml, exiting program\n\n";        // show error message
    ...
    cv::FileStorage fsTrainingImages("/home/pi/QT5/T4/images.xml", cv::FileStorage::READ);              // open the training images file

    if (fsTrainingImages.isOpened() == false) {                                                 // if the file was not opened successfully
        std::cout << "error, unable to open training images file image.xml exiting program\n\n";         // show error message
        return(false);                                                                          // and exit program
    }
